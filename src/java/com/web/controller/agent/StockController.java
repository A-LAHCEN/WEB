...
public class StockController extends HttpServlet {
    ...
    private boolean stockAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("ADD") != null) {
            ...
            if (stock.isValid()) {
                ...
                request.getRequestDispatcher("/WEB-INF/public/WebAgent/stock/add.jsp").forward(request, response);
            }
            response.sendError(400,"erooooor");
    ...
    private boolean searchAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("libele") != null) {
            request.setAttribute("entites", entityManager.findAll("WebStock.findByLibele", request.getParameter("libele")));
        }
