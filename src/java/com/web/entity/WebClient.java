...
public class WebClient extends WebEntity {
    ...
    private Collection<WebFacture> factures = new ArrayList<>();
    ...
    public WebClient(HttpServletRequest request) {
        ...
        if (request.getParameter("credit") != null && !request.getParameter("credit").equals("")) {
            this.credit = Double.valueOf(request.getParameter("credit"));
        }
    }
    ...
    public WebClient setCredit(double credit) {
        this.credit = credit;
        return this;
    }
    ...
    public WebClient setDebit(double debit) {
        this.debit = debit;
        return this;
    }
    ...
    public Collection<WebFacture> getFactures() {
        return factures;
    }

    public WebClient setFactures(Collection<WebFacture> factures) {
