    ...
    <section class="content invoice">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <c:if test="${entity.type ne 'COMMANDE'}">
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <c:forEach items="${entity.reglements}" var="item">
                    <tr title="${item.ref}">
        ...
        <div class="row hidden-print">
            <div class="col-xs-12">
                <form method="POST" class="form-show" action="" target="">
                    <input type="hidden" name="facture" value="${entity.id}">
                    <input type="hidden" name="CREATE" value="TRUE">
                    <input type="hidden" name="SUIVIE" value="TRUE">
                    <button class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-credit-card"></i></button>
                </form>
