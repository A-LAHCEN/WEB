                            ...
                            <tr class="${entity.etat ?'':'danger'}">
                                ...
                                <td style="width: 100px;">
                                    <form class="form-show" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-xs btn-block"><span class="fa fa-edit"></span></button>
                                    </form>
                                </td>
                                <td style="width: 100px;">
